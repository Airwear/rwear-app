...
export default function SettingsScreen() {
  ...
  // Appelle l’API et gère l’état de chargement lors de la suppression du compte
  ...
  const confirmDelete = () => {
    Alert.alert(
      'Supprimer le compte',
      'Cette action est définitive et supprimera toutes vos données. Voulez-vous continuer ?',
      [
